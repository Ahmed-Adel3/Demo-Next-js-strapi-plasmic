...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: Z7hdOyZhPFbK/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: NE3bvRR_z4X4/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: OMc7SlCYPT93/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__rk04Y)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__ar3X)}
                role={"img"}
              />
            ),
